      ...
      <div className="main-wrapper">
    	   <div className="main_header">
    			<div className="custom-container-fluid">
                  ...
                  <h1><figure><img src="/assets/images/top-logo.png"/></figure></h1>
                ...
                <div className="main_banner_row">
                    <div className="mian_banner_text">
                        ...
                        <ul className="banner_video">
                            <a className="main_button btn2 hover-affect" href="#">Learn More</a>
                    ...
                    <div className="pet_service_row">
                      <div className="pet_service_column">
                          <figure>
                              ...
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img.png" alt="image"/></a>
                          </figure>
                          <h6>Dog</h6>
                      </div>
                     <div className="pet_service_column">
                          <figure>
                              <img src="/assets/images/service_bg.png" alt="image"/>
                              <img className="hover_img" src="/assets/images/service_bg_hover.png" alt="image"/>
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img01.png" alt="image"/></a>
                          </figure>
                          <h6>Cat</h6>
                      </div>
                     <div className="pet_service_column">
                          <figure>
                              <img src="/assets/images/service_bg.png" alt="image"/>
                              <img className="hover_img" src="/assets/images/service_bg_hover.png" alt="image"/>
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img02.png" alt="image"/></a>
                          </figure>
                          <h6>Parrots</h6>
                      </div>
                      <div className="pet_service_column">
                          <figure>
                              <img src="/assets/images/service_bg.png" alt="image"/>
                              <img className="hover_img" src="/assets/images/service_bg_hover.png" alt="image"/>
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img03.png" alt="image"/></a>
                          </figure>
                          <h6>Fish</h6>
                      </div>
                      <div className="pet_service_column">
                          <figure>
                              <img src="/assets/images/service_bg.png" alt="image"/>
                              <img className="hover_img" src="/assets/images/service_bg_hover.png" alt="image"/>
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img04.png" alt="image"/></a>
                          </figure>
                          <h6>Live Stock</h6>
                      </div>
                      <div className="pet_service_column">
                          <figure>
                              <img src="/assets/images/service_bg.png" alt="image"/>
                              <img className="hover_img" src="/assets/images/service_bg_hover.png" alt="image"/>
                              <a className="icon_img" href="#"><img src="/assets/images/icon-img05.png" alt="image"/></a>
                          </figure>
                          <h6>Other Animals</h6>
                      </div>
                  </div>
                ...
                <div className="pet_about_row">
                   <div className="pet_about_fig">
                    ...
                    <div className="pet_about_text">
                        ...
                        <a className="main_button btn2 bdr-clr hover-affect" href="#">Learn More</a>
                    </div>
                </div>
            </div>
        </section> 
                ...
                <div className="pet_price_table_column">
                  ...
                  <div className="pet_price_text">
                    ...
                    <ul className="pet_price_list">
                      <li><a href="#"><i className="fa fa-check"></i>Pet Shower</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Fitness Checkup</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Pet Grooming</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Hair And Nail Cut</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Control Hair Falling</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Brush & Blow Dry</a></li>
                      <li><a href="#"><i className="fa fa-check"></i>Pet Park And Games</a></li>
                    </ul>
                    <a className="main_button btn2 bdr-clr hover-affect" href="#">Chosse a plan</a>
                  </div>
                </div>
              ...
              <div className="main_widget_row">
                <div className="widget_contact">
                  ...
                  <div className="main_widget_column">
                    ...
                    <div className="main_widget_contact">
                      <a href="#">info@pawsome.com</a>
                      <a href="#">Support@pawsome.com</a>
                    </div>
                  </div>
                  <div className="main_widget_column">
                ...
                <div className="pet_widget_column">
                  ...
                  <ul className="widget_social_share">
                    <li><a className="hover-affect" href="#"><i className="fa fa-facebook"></i></a></li>
                    <li><a className="hover-affect" href="#"><i className="fa fa-twitter"></i></a></li>
                    <li><a className="hover-affect" href="#"><i className="fa fa-camera"></i></a></li>
                    <li><a className="hover-affect" href="#"><i className="fa fa-youtube"></i></a></li>
                  </ul>
