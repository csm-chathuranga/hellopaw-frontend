...
import { getBanks,deletebanks } from "../../services/bank";
...
const BankList = () => {
  ...
  return (
    ...
    <Box display="flex" flexDirection="column" alignItems="flex-end">
      ...
      <Button variant="contained" onClick={()=>navigate('/bank/add')} style={{ marginBottom: '10px', backgroundColor: '#4caf50', color: 'white',width:'100x' }}>+ Add new</Button>
      </Box>
            ...
            {data.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell style={{ padding: '5px' }}>
                  <Button variant="outlined"  startIcon={<EditIcon />} onClick={()=>navigate('/bank/add/'+ item.id)}>Edit</Button>
